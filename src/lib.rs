...
#[derive(Debug)]
pub struct NeoElasticProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NeoElasticProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NeoElastic processing");
    
    let mut processor = NeoElasticProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NeoElasticProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NeoElasticProcessor::new(false);
